...
// @match        *://*/*
// @icon         https://gitee.com/mrlee666/img/raw/master/test/32.png
...
(async function () {
                ...
                for (const iframe of iframes) {
                    try {
                        if (iframe.contentWindow.VideoTogetherParentInject != true &&
                            ...
                            script.src = "https://quantil.jsdelivr.net/gh/fxck1024/proxy/live.js";
    ...
    try {
        ...
        if (cachedVersion == vtRefreshVersion) {
            ...
            fetch(`https://quantil.jsdelivr.net/gh/fxck1024/proxy/zh.js?vtRefreshVersion=` + vtRefreshVersion)
                .then(r => r.text())
    ...
    <div id="videoTogetherLoadingwrap">
        <img style="display: inline;" src="data:image/png;base64,">
...
`;
    ...
    switch (type) {
        case "userscript":
            script.src = `https://quantil.jsdelivr.net/gh/fxck1024/proxy/zh.js?timestamp=` + version;
            break;
        case "Chrome":
        case "Safari":
        case "Firefox":
            ...
            document.addEventListener("securitypolicyviolation", (e) => {
                ...
                if (urlDisabled) {
                    ...
                    insertJs(getBrowser().runtime.getURL(`zh.js`));
                    hotUpdated = true;
                }
            });
            if (isDevelopment) {
                script.src = getBrowser().runtime.getURL(`zh.js`);
            } else {
                script.src = getBrowser().runtime.getURL(`zh.js`);
            }
        ...
        case "userscript_beta":
            script.src = `https://quantil.jsdelivr.net/gh/fxck1024/proxy/zh.js?timestamp=` + parseInt(Date.now());
            break;
        case "website":
            script.src = `https://quantil.jsdelivr.net/gh/fxck1024/proxy/zh.js?timestamp=` + version;
            break;
    ...
    setTimeout(() => {
        ...
        if (!ExtensionInitSuccess) {
            let script = document.createElement('script');
            script.type = 'text/javascript';
            script.src = `https://quantil.jsdelivr.net/gh/fxck1024/proxy/zh.js`;
            (document.body || document.documentElement).appendChild(script);
            try {
                if (isWebsite) {
                    InsertInlineJs(script.src);
